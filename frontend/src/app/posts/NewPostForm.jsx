...
const NewPostForm = ({ isPostFormOpen, setIsPostFormOpen }) => {
  ...
  const { handleCreatePost } = postStore();
  ...
  return (
    <Card className="mt-[70px] font-sans">
      <CardContent className="pt-5 pl-4">
          ...
          <Dialog open={isPostFormOpen} onOpenChange={setIsPostFormOpen}>
            <DialogTrigger className="w-full">
              <Input
                ...
                readOnly
                className="cursor-pointer rounded-full h-10  dark:bg-[rgb(58,59,60)] placeholder:text-gray-500 dark:placeholder:text-gray-400  "
              />
            ...
            <DialogContent className="sm:max-w-[525px] max-h-[80vh] overflow-y-auto">
              ...
              <div className="flex justify-end mt-4">
                <Button className="bg-blue-500 text-white font-sans"
                 onClick={handlePost}>
                  {loading ? "Saving..." : "Post"}
                </Button>
              </div>
